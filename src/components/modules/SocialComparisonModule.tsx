    ...
    <Card className={fullWidth ? "w-full" : "w-full"}>
      <CardHeader className="pb-2">
        <CardTitle className="text-xl text-blue-700 dark:text-blue-300 flex items-center">
          ...
          <Badge className="ml-3 bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200">
          ...
          <div className={`grid ${fullWidth ? "grid-cols-2" : "grid-cols-1 md:grid-cols-2"} gap-4`}>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 p-3 rounded-lg">
              ...
              <div className="flex items-center">
                ...
                <Badge className="ml-2" variant={socialComparison.diversificationScore > 70 ? "default" : "secondary"}>
