  ...
  return (
    <div className="mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="reinvent-stat-card border-emerald-500/20 bg-emerald-900/10">
        ...
        <div className="reinvent-stat-card border-amber-500/20 bg-amber-900/10">
          <div className="flex items-start mb-3">
        ...
        <div className="reinvent-stat-card border-blue-500/20 bg-blue-900/10">
          <div className="flex items-start mb-3">
