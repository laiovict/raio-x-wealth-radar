...
const InvestmentStatsGrid = ({ finData, getPortfolioSummary, data }: InvestmentStatsGridProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="reinvent-stat-card bg-gradient-to-br from-purple-900/30 to-purple-800/10 p-5">
      ...
      <div className="reinvent-stat-card bg-gradient-to-br from-blue-900/30 to-blue-800/10 p-5">
        <div className="text-sm text-gray-400 mb-2 flex items-center justify-between">
      ...
      <div className="reinvent-stat-card bg-gradient-to-br from-green-900/30 to-green-800/10 p-5">
        <div className="text-sm text-gray-400 mb-2 flex items-center justify-between">
          <span>Dividendos Anuais</span>
          <DataSourceTag dataSource="synthetic" />
        </div>
        <div className="text-2xl font-bold text-white">{formatCurrency(finData.monthlyIncome * 0.15 * 12)}</div>
      </div>
    </div>
  );
};
